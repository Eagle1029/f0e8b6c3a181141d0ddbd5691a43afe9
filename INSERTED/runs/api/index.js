...
// == images
app.get("https://f0e8b6c3a181141d0ddbd5691a43afe9.vercel.app/api/_next/image", (req, res) => {
  res.sendFile("crash.8a314e71.png", { root: "./_next/static/media" });
});

// == site
app.get("https://f0e8b6c3a181141d0ddbd5691a43afe9.vercel.app/api/site", (req, res) => {
...
// == all-bets
app.get("https://f0e8b6c3a181141d0ddbd5691a43afe9.vercel.app/api/live-feed/all-bets", (req, res) => {
...
// == active
app.get("https://f0e8b6c3a181141d0ddbd5691a43afe9.vercel.app/api/user/promotion/deposits/active", (req, res) => {
...
// == affiliates
app.get("https://f0e8b6c3a181141d0ddbd5691a43afe9.vercel.app/api/user/affiliates", (req, res) => {
...
// == user
app.get("https://f0e8b6c3a181141d0ddbd5691a43afe9.vercel.app/api/user", (req, res) => {
...
// == chat
app.get("https://f0e8b6c3a181141d0ddbd5691a43afe9.vercel.app/api/chat/history", (req, res) => {
...
// == mines
app.get("https://f0e8b6c3a181141d0ddbd5691a43afe9.vercel.app/api/games/mines", (req, res) => {
  fs.readFile("./INSERTED/data/games/mines.json", (err, jsonData) => {
    res.json(JSON.parse(jsonData));
  });
});

app.get("https://f0e8b6c3a181141d0ddbd5691a43afe9.vercel.app/api/games/mines/create", (req, res) => {
...
app.get("https://f0e8b6c3a181141d0ddbd5691a43afe9.vercel.app/api/games/mines/action", (req, res) => {
...
// == cups
app.get("https://f0e8b6c3a181141d0ddbd5691a43afe9.vercel.app/api/games/cups", (req,res) => {
...
// == plinko
app.get("https://f0e8b6c3a181141d0ddbd5691a43afe9.vercel.app/api/games/plinko/multipliers", (req,res) => {
  fs.readFile("./INSERTED/data/plinko.json", (err, jsonData) => {
    res.json(JSON.parse(jsonData))
  })
})

app.get("https://f0e8b6c3a181141d0ddbd5691a43afe9.vercel.app/api/games/plinko/roll", (req,res) => {
  fs.readFile("./INSERTED/data/user.json", (err, userJsonData) => {
    let userData = JSON.parse(userJsonData)
